...
/***/ function(module, exports, __webpack_require__) {
	...
	var Commoner = __webpack_require__(1);

	var btn = document.getElementById('dlkBtn');

	btn.addEventListener('click', function(e) {

	  var commoner = new Commoner();
	  commoner.handleClick(e);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;module.exports = Commoner;

	function Commoner() {

	}

	Commoner.protoype.handleClick = function(e) {

	  console.log('AT');
	  !(__WEBPACK_AMD_DEFINE_FACTORY__ = (['./amder.js', function(amder) {

	    amder('Commoner -> AMDer :)');
